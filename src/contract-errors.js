...
function ContractError(/* opt */ context, /* opt */ msg) {
  ...
  const hasBlame = this.context && this.context.thingName
  ...
  if (this.context && this.context.wrappedAt && this.context.wrappedAt[0]) {
    const callsite = this.context.wrappedAt[0]
